    ...
    <main className="min-h-screen bg-[#faf9f6] pt-20 pb-20">
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex items-center gap-3 mb-8">
          <Link
            href="/cart"
            className="w-10 h-10 rounded-full bg-white flex items-center justify-center shadow-sm text-gray-500 hover:text-[var(--olive)] hover:scale-105 transition-all border border-gray-100"
          >
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="bg-white rounded-[2rem] p-6 sm:p-8 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.04)] border border-gray-100">
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="text-[11px] font-bold text-[var(--orange)] tracking-widest hover:underline uppercase">
                  {t.my_account?.edit || "Change"}
                </button>
              </div>
              ...
              <div className="p-5 rounded-2xl border-2 border-[var(--olive)]/20 bg-[#faf9f6] relative cursor-pointer hover:shadow-md transition-all">
                <div className="flex flex-wrap items-center gap-3 mb-3">
                  <span className="inline-block px-3 py-1 bg-white shadow-sm text-[var(--olive)] border border-gray-100 text-[10px] font-bold tracking-widest rounded-md">
                    HOME
                  </span>
            ...
            <div className="bg-white rounded-[2rem] p-6 sm:p-8 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.04)] border border-gray-100">
              ...
              <div className="space-y-4">
                <label
                  className={`flex items-center p-5 rounded-2xl border-2 cursor-pointer transition-all ${paymentMethod === "upi" ? "border-[var(--olive)] bg-[var(--olive)]/5 shadow-sm" : "border-gray-100 hover:border-gray-200"}`}
                >
                  <input
                    type="radio"
                    name="payment"
                    className="w-5 h-5 accent-[var(--olive)] mr-4"
                ...
                <label
                  className={`flex items-center p-5 rounded-2xl border-2 cursor-pointer transition-all ${paymentMethod === "card" ? "border-[var(--olive)] bg-[var(--olive)]/5 shadow-sm" : "border-gray-100 hover:border-gray-200"}`}
                >
                  <input
                    type="radio"
                    name="payment"
                ...
                <label
                  className={`flex items-center p-5 rounded-2xl border-2 cursor-pointer transition-all ${paymentMethod === "cod" ? "border-[var(--olive)] bg-[var(--olive)]/5 shadow-sm" : "border-gray-100 hover:border-gray-200"}`}
                >
                  <input
                    type="radio"
                    name="payment"
          ...
          <div className="w-full lg:w-[400px] shrink-0">
            <div className="bg-white rounded-[2rem] p-6 sm:p-8 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.04)] border border-gray-100 sticky top-28">
                ...
                <div className="flex items-center gap-4">
                  <div className="relative w-14 h-14 rounded-xl bg-gray-50 overflow-hidden shrink-0 border border-gray-100 shadow-sm">
                    <Image
                      ...
                      alt="product"
                    />
                    <span className="absolute -top-1 -right-1 w-5 h-5 rounded-full bg-[var(--olive)] text-white text-[10px] font-bold flex items-center justify-center border border-white shadow-sm z-10">
                      1
                    </span>
                  </div>
                  <div className="flex-1">
              ...
              <p className="text-[10px] text-center text-gray-400 mt-5 leading-relaxed">
                ...
                <Link href="/policies/terms-policy" className="underline hover:text-[var(--olive)]">
                  {t.termsLink || "Terms & Conditions"}
                </Link>{" "}
                and{" "}
                <Link href="/policies/privacy-policy" className="underline hover:text-[var(--olive)]">
