    ...
    <main className="min-h-screen bg-[var(--background)] overflow-x-hidden">
      ...
      <section className="py-20 max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-16">
              ...
              <div className="flex items-center justify-between p-6 rounded-[1.5rem] bg-white border border-gray-100 shadow-sm transition-all duration-300 hover:bg-gray-50/50 group cursor-pointer">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/919940620019" target="_blank" rel="noopener noreferrer" className="text-sm font-bold text-gray-900">
                      +91 9940620019
                    </a>
                  </div>
                </div>
          ...
          >
            <div className="bg-white rounded-[2rem] p-8 md:p-12 shadow-[0_30px_70px_rgba(85,107,47,0.08)] border border-gray-100 relative">
              {/* Form Header */}
              <div className="mb-8">
