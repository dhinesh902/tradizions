        ...
        <div className="bg-white rounded-[2.5rem] p-6 lg:p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] border border-gray-100 flex flex-col lg:flex-row gap-12 relative overflow-hidden">
          ...
          <div className="w-full lg:w-1/2 flex flex-col pt-4 relative z-10">
            ...
            <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight mb-2">
              Handcrafted Brass Diya Set
            </h1>
            <p className="text-gray-500 font-medium mb-6">
              Illuminate your sacred spaces with this intricately designed,
              authentic brass diya set. Perfect for daily pooja and festive
              gifting.
            </p>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-500 leading-relaxed font-light">
                ...
                methods, this Brass Diya Set brings a touch of ancestral
                elegance to your home. The heavy brass construction ensures
                long-lasting durability while the golden finish reflects light
                beautifully, creating a warm and divine atmosphere during your
                prayers.
              </p>
            </div>
          </div>
            ...
            {[1, 2, 3].map((_, i) => (
              ...
              >
                ...
                <p className="text-sm text-gray-600 leading-relaxed font-light">
                  I gifted this to my family for Diwali and they absolutely
                  loved it! The packaging feels extremely premium and the
                  quality of the item itself is outstanding. Highly recommended
                  for gifting!
                </p>
              </div>
            ))}
