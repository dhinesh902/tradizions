          ...
          <div className="w-full lg:w-1/2 flex flex-col pt-4">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-2">
                <button className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 hover:bg-red-50 hover:text-red-500 transition-colors cursor-pointer">
                  <Heart className="w-5 h-5" />
                </button>
                <button className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-500 hover:bg-gray-100 hover:text-gray-900 transition-colors cursor-pointer">
            ...
            <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight mb-2">
              Premium Barnyard Millet
            </h1>
            <p className="text-gray-500 font-medium mb-6">
              Authentic, unpolished, and nutrient-dense grains sourced directly
              from ethical organic farmers.
            </p>
            ...
            <div className="flex flex-col gap-4 mb-8">
              ...
              <button className="w-full py-4 rounded-2xl bg-[var(--olive)] text-white font-bold text-[13px] tracking-widest shadow-lg shadow-[var(--olive)]/20 hover:shadow-xl hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 group">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-8 py-8 border-t border-b border-gray-100 my-8">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <span className="text-sm font-bold text-stone-800 leading-relaxed font-medium">
                  Store in a cool, dry place. Once opened, transfer to an
                  airtight container.
                </span>
              </div>
              <div className="flex flex-col gap-1.5">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-gray-500 leading-relaxed font-light">
                Barnyard millet is a wild seed that is grown mainly in the hilly
                areas of Uttaranchal, India. It is highly nutritious and is an
                excellent source of dietary fiber, protein, and essential
                minerals like iron and zinc. Perfect for creating healthy
                porridges, upmas, and traditional sweets.
              </p>
          ...
          {showReviewForm && (
            <div className="mb-10 bg-[#faf9f6] rounded-[2rem] p-6 lg:p-8 border border-gray-100 animate-fade-in-up">
              ...
              <form className="space-y-6 max-w-2xl">
                ...
                <button
                  type="button"
                  className="btn-standard rounded-xl font-bold text-[13px] tracking-widest shadow-md shadow-[var(--olive)]/20 hover:shadow-lg hover:-translate-y-0.5 transition-all"
                >
            ...
            {[1, 2, 3].map((_, i) => (
              ...
              >
                ...
                <p className="text-sm text-gray-600 leading-relaxed font-light">
                  ...
                  arrived perfectly packaged. Will definitely be ordering again.
                  Highly recommend to everyone looking for authentic, organic
                  items.
                </p>
              </div>
            ))}
