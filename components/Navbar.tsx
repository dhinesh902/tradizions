                ...
                <div className="absolute top-full right-0 mt-3 w-40 bg-white border border-gray-100 rounded-xl shadow-2xl z-50 py-2 animate-fade-in-up">
                  {languages.map((lang) => (
                    <button
                      ...
                      className={`w-full text-left px-5 py-2.5 text-[11px] font-bold tracking-widest transition-all hover:bg-gray-50 ${selectedLang === lang.code ? "text-[var(--olive)] bg-[var(--olive)]/5" : "text-gray-600"
                        }`}
                    >
                      {lang.name}
                    </button>
        ...
        <div className="flex flex-col h-full relative overflow-hidden">
          ...
          {!isLoggedIn && (
            ...
            <div className="flex-1 flex flex-col px-10 py-20 animate-fade-in-right">
              <div className="mb-10">
                <div className="w-12 h-12 rounded-2xl bg-amber-50 text-[var(--orange)] flex items-center justify-center mb-6 shadow-sm">
